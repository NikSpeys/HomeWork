...
def test_filter_by_currency_not_code(transactions, transactions_usd):
    result = filter_by_currency(transactions, "RUB")
    assert not list(result)


def test_filter_by_currency_not_dict():
...
def test_transaction_descriptions_none(transactions):
    result_1 = transaction_descriptions([])
    assert not list(result_1)
